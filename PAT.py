...
#AUTHOR : CHIGOZIEWORLDWIDE (PAT)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO PAT
...
header = {"user-agent": '[Mozilla/5.0 (Windows; U; Windows NT 5.1; ja-JP) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/533.19.4;]',
